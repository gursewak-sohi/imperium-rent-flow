<template>
         ...
         <div class="modal-content billingReportTable">
            ...
            <div class="modal-footer">
               ...
               <button type="button" class="btn btn-primary" data-dismiss="modal" v-on:click="fetchData1">Fetch Report</button>
            </div>
         ...
         this.$loading.show({delay:0}) 
           ...
           let ed = eyear+'-'+(emonth <= 9 ? '0'+emonth:emonth)+'-'+(eday <= 9 ? '0'+eday:eday);
            ...
            axios.post( 'https://severify.com/api/cases/report',
                ...
                .catch(function(){
                  //  console.log(vm.$refs.usernameInput, '9999999')
                console.log('FAILURE!!');
                });
        }
      }   
