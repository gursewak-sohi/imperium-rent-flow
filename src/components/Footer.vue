    ...
    <footer>
        <div class="container">
            <div class="footer-top">
                ...
                <div class="footer-unit">
                    <h4>SUPPORT</h4>
                    <p><a href="mailto:support@bytheseat.com">support@bytheseat.com</a> <br> 3705 W Pico Blvd (#591),<br> Los Angeles, CA <br/> <a href="https://www.google.com/maps/place/3705+W+Pico+Blvd,+Los+Angeles,+CA+90019,+USA/@34.0475447,-118.3237152,17z" target="_blank">Map</a></p>
                </div>
                <div class="footer-content">
                    ...
                    <div class="footer-social">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="https://www.instagram.com/ImperiumJets/" target="_blank" nofollow="" noindex="">
                                    <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
